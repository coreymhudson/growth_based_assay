...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		NEXT_PUBLIC_ARRANGER_GROWTH_MANIFEST_COLUMNS: process.env.NEXT_PUBLIC_ARRANGER_GROWTH_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_GROWTH_MAX_BUCKET_COUNTS: process.env.NEXT_PUBLIC_ARRANGER_GROWTH_MAX_BUCKET_COUNTS || 1000,
		...
		NEXT_PUBLIC_ENABLE_GROWTH_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_INSTRUMENT_QUICKSEARCH,
